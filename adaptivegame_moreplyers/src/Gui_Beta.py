...
class AdaptIODisplay():
    ...
    def updatePlayers(self):
        ...
        for i in range(len(self.players)):
            ...
            if self.players[i].active:
                pygame.draw.rect(self.SCREEN, playerColor, rect, 0)
            else:
    ...
    def updateScoreBoard(self):
        ...
        players.sort(key = lambda x: x.size, reverse = True)
        for i in range(0, 4):
            self.drawPlayerBoard(i, players[i].name, players[i].size, players[i].active)
    ...
    def drawPlayerBoard(self, player_id, player_name, player_size, active):
        ...
        pygame.draw.rect(self.SCREEN, playerColor, flag, 0)
